...
import github.kasuminova.mmce.common.tile.MEItemOutputBus512;
...
public class BlockMEItemOutputBus512 extends BlockMEItemBus {
    ...
    public boolean onBlockActivated(
        ...
        if (!worldIn.isRemote) {
            ...
            if (te instanceof MEItemOutputBus512) {
    ...
    public void breakBlock(final World worldIn,
        ...
        TileEntity te = worldIn.getTileEntity(pos);
        ItemStack dropped = new ItemStack(ItemsMM.meItemOutputBus512);
        ...
        if (!(te instanceof final MEItemOutputBus512 bus)) {
            spawnAsEntity(worldIn, pos, dropped);
            worldIn.removeTileEntity(pos);
            return;
        }
    ...
    public void onBlockPlacedBy(@Nonnull final World worldIn,
        ...
        if (te instanceof MEItemOutputBus512 && tag != null && tag.hasKey("inventory")) {
            ((MEItemOutputBus512) te).readInventoryNBT(tag.getCompoundTag("inventory"));
        }
    }
}
