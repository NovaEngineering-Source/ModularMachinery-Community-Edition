...
import github.kasuminova.mmce.common.tile.MEItemOutputBus64;
...
public class BlockMEItemOutputBus64 extends BlockMEItemBus {
    ...
    public boolean onBlockActivated(
        ...
        if (!worldIn.isRemote) {
            ...
            if (te instanceof MEItemOutputBus64) {
    ...
    public void breakBlock(final World worldIn,
        ...
        TileEntity te = worldIn.getTileEntity(pos);
        ItemStack dropped = new ItemStack(ItemsMM.meItemOutputBus64);
        ...
        if (!(te instanceof final MEItemOutputBus64 bus)) {
            spawnAsEntity(worldIn, pos, dropped);
            worldIn.removeTileEntity(pos);
            return;
        }
    ...
    public void onBlockPlacedBy(@Nonnull final World worldIn,
        ...
        if (te instanceof MEItemOutputBus64 && tag != null && tag.hasKey("inventory")) {
            ((MEItemOutputBus64) te).readInventoryNBT(tag.getCompoundTag("inventory"));
        }
    }
}
