...
import github.kasuminova.mmce.common.tile.MEItemOutputBus8192;
...
public class BlockMEItemOutputBus8192 extends BlockMEItemBus {
    ...
    public boolean onBlockActivated(
        ...
        if (!worldIn.isRemote) {
            ...
            if (te instanceof MEItemOutputBus8192) {
    ...
    public TileEntity createTileEntity(final World world, final IBlockState state) {
        return new MEItemOutputBus8192();
    }
    ...
    public void breakBlock(final World worldIn,
        ...
        TileEntity te = worldIn.getTileEntity(pos);
        ItemStack dropped = new ItemStack(ItemsMM.meItemOutputBus8192);
    ...
    public void onBlockPlacedBy(@Nonnull final World worldIn,
        ...
        if (te instanceof MEItemOutputBus8192 && tag != null && tag.hasKey("inventory")) {
            ((MEItemOutputBus8192) te).readInventoryNBT(tag.getCompoundTag("inventory"));
        }
    }
}
