...
public class MEItemOutputBus512 extends MEItemBus {
    ...
    public ItemStack getVisualItemStack() {
        return new ItemStack(ItemsMM.meItemOutputBus512);
    }
    ...
    public void onLoad() {
        ...
        if (inventory != null) {
            ...
            inventory.setStackLimit(512, allSlots);
        }
    }
}